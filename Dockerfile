...
ARG NEXT_PUBLIC_DEV_PHONE_NUMBER
...
ENV NEXT_PUBLIC_DEV_PHONE_NUMBER=$NEXT_PUBLIC_DEV_PHONE_NUMBER
...
RUN echo "NEXT_PUBLIC_URL=${NEXT_PUBLIC_URL}" && \
    ...
    echo "NEXT_PUBLIC_DEV_PHONE_NUMBER=${NEXT_PUBLIC_DEV_PHONE_NUMBER}" && \
